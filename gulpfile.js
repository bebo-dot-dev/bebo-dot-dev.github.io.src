...
function doWatch(done) {
	...
	watch(['*.html', '_includes/*.html', '_layouts/*.html', '_posts/*'], doJekyllRebuild);
}
 ...
 */
 exports.default = series(doStylus, doJs, doImageMin, doBrowserSync, doWatch);
 exports.build = series(doStylus, doJs, doImageMin, doJekyllBuild);
